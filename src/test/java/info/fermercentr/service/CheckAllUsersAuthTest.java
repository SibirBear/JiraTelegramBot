...
class CheckAllUsersAuthTest {
    ...
    static void init() throws NoSuchFieldException, IllegalAccessException {
        ...
        User user1 = new User("1", Steps.STEP102);
        ...
        User user2 = new User("2", Steps.STEP103);
        ...
        User user3 = new User("3", Steps.STEP102);
        ...
        User user4 = new User(CoreConstants.NOT_AUTH, Steps.STEP102);
        ...
        User user5 = new User(CoreConstants.NOT_AUTH, Steps.STEP102);
        storeUsers.save(5, user5);

        User user6 = new User(CoreConstants.NOT_AUTH, Steps.STEP103);
        storeUsers.save(6, user6);

        User user7 = new User(CoreConstants.NOT_AUTH, Steps.STEP102);
        ...
        User user8 = new User(CoreConstants.NOT_AUTH, Steps.STEP102);
        ...
        User user9 = new User(CoreConstants.NOT_AUTH, Steps.STEP103);
        ...
        User userEx2 = new User("2", Steps.STEP103);
        expected.save(2, userEx2);

        User userEx3 = new User("3", Steps.STEP102);
        expected.save(3, userEx3);

        User userEx5 = new User("5", Steps.STEP102);
        expected.save(5, userEx5);

        User userEx6 = new User(CoreConstants.NOT_AUTH, Steps.STEP103);
        expected.save(6, userEx6);

        User userEx7 = new User(CoreConstants.NOT_AUTH, Steps.STEP102);
